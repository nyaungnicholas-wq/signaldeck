...
the daemon stops publishing it. Chained digest matches the graded rule: 353450b995a52bcea9257a8520369d8841e7fa71c70295aae925dc7cf03b429f.
  directional-ensemble (1d): n=2,617 over 20 days, design effect 7.4x -> effective n 355
  prequential-majority (1d): n=2,288 over 18 days, design effect 23.6x -> effective n 97
  directional-ensemble (1w): n=4,325 over 18 days, design effect 12.5x -> effective n 347
  prequential-majority (1w): n=3,964 over 16 days, design effect 12.3x -> effective n 322
  directional-ensemble (1w, high conviction): n=490 over 16 days, design effect 2.5x -> effective n 192
...
Reliability (predicted P(up) vs realized up-frequency, independent symbol-days):
  ...
  1d: p in [0.3,0.4) mean 0.372 -> realized 0.633 (n=343, 8 days)
  1d: p in [0.4,0.5) mean 0.468 -> realized 0.577 (n=1491, 18 days)
  1d: p in [0.5,0.6) mean 0.552 -> realized 0.551 (n=381, 15 days)
  ...
  1w: p in [0.1,0.2) mean 0.176 -> realized 0.675 (n=80, 6 days) <- conviction tier
  1w: p in [0.2,0.3) mean 0.258 -> realized 0.583 (n=103, 11 days) <- conviction tier
  1w: p in [0.3,0.4) mean 0.363 -> realized 0.628 (n=1073, 17 days)
  1w: p in [0.4,0.5) mean 0.449 -> realized 0.588 (n=1902, 12 days)
  1w: p in [0.5,0.6) mean 0.545 -> realized 0.562 (n=1028, 10 days)
  1w: p in [0.6,0.7) mean 0.627 -> realized 0.652 (n=115, 7 days)
...
Universe completeness (direction): listing status resolvable for all 466 graded symbols — survivorship_clean.
Universe completeness (structure): NOT CLEAN — unmeasured — no graded post-epoch symbols. Rows carry survivorship_clean=false.
Stale-feed quarantine: 368 graded observation(s) over 57 symbol(s) and 22 trading day(s) EXCLUDED - minted on a day this symbol's own feed was flagged stale (dq_events kind='stale'), so the inputs behind the call had already been declared unfit. Grading them would measure the outage, not the predictor.
Survivorship bound (measured 2026-08-20T21:05:05Z, edgar:form-25): 10 symbol(s) left the tracked universe since 2026-07-24 vs 466 graded. If every dropped symbol
had kept being graded and been WRONG every time, headline accuracy would fall by at most 0.97 pp.
