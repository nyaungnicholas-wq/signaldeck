...
the daemon stops publishing it. Chained digest matches the graded rule: 353450b995a52bcea9257a8520369d8841e7fa71c70295aae925dc7cf03b429f.
  directional-ensemble (1d): n=2,695 over 22 days, design effect 7.2x -> effective n 374
  prequential-majority (1d): n=2,366 over 20 days, design effect 22.9x -> effective n 104
...
Reliability (predicted P(up) vs realized up-frequency, independent symbol-days):
  ...
  1d: p in [0.4,0.5) mean 0.469 -> realized 0.574 (n=1567, 20 days)
  ...
  1w: p in [0.1,0.2) mean 0.176 -> realized 0.667 (n=84, 8 days) <- conviction tier
  1w: p in [0.2,0.3) mean 0.257 -> realized 0.565 (n=115, 13 days) <- conviction tier
  1w: p in [0.3,0.4) mean 0.364 -> realized 0.615 (n=1139, 19 days)
  1w: p in [0.4,0.5) mean 0.448 -> realized 0.584 (n=2104, 14 days)
  1w: p in [0.5,0.6) mean 0.545 -> realized 0.561 (n=1101, 13 days)
  1w: p in [0.6,0.7) mean 0.628 -> realized 0.620 (n=142, 9 days)
  1w: p in [0.7,0.8) mean 0.729 -> realized 0.360 (n=25, 7 days) <- conviction tier
  1w: p in [0.8,0.9) mean 0.836 -> realized 0.500 (n=4, 2 days) <- conviction tier
...
Universe completeness (direction): listing status resolvable for all 654 graded symbols — survivorship_clean.
Universe completeness (structure): listing status resolvable for all 135 graded symbols — survivorship_clean.
Stale-feed quarantine: 402 graded observation(s) over 69 symbol(s) and 22 trading day(s) EXCLUDED - minted on a day this symbol's own feed was flagged stale (dq_events kind='stale'), so the inputs behind the call had already been declared unfit. Grading them would measure the outage, not the predictor.
Survivorship bound (measured 2026-08-26T01:49:57Z, edgar:form-25): 7 symbol(s) left the tracked universe since 2026-07-24 vs 654 graded. If every dropped symbol
had kept being graded and been WRONG every time, headline accuracy would fall by at most 0.50 pp.
