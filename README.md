...
Verified this run: 72.4% of graded outcomes carry a frozen baseline.
...
the daemon stops publishing it. Chained digest matches the graded rule: 353450b995a52bcea9257a8520369d8841e7fa71c70295aae925dc7cf03b429f.
  ...
  prequential-majority (1d): n=2,470 over 23 days, design effect 22.0x -> effective n 112
...
Reliability (predicted P(up) vs realized up-frequency, independent symbol-days):
  ...
  1w: p in [0.0,0.1) mean 0.044 -> realized 0.333 (n=18, 9 days) <- conviction tier
  1w: p in [0.1,0.2) mean 0.169 -> realized 0.664 (n=107, 14 days) <- conviction tier
  1w: p in [0.2,0.3) mean 0.259 -> realized 0.526 (n=137, 19 days) <- conviction tier
  1w: p in [0.3,0.4) mean 0.363 -> realized 0.601 (n=1217, 26 days)
  1w: p in [0.4,0.5) mean 0.448 -> realized 0.577 (n=2243, 20 days)
  1w: p in [0.5,0.6) mean 0.544 -> realized 0.553 (n=1220, 19 days)
  1w: p in [0.6,0.7) mean 0.633 -> realized 0.583 (n=216, 15 days)
  1w: p in [0.7,0.8) mean 0.738 -> realized 0.338 (n=65, 13 days) <- conviction tier
  1w: p in [0.8,0.9) mean 0.853 -> realized 0.238 (n=21, 10 days) <- conviction tier
...
Universe completeness (direction): NOT CLEAN — listing status resolvable for 329/1043 graded symbols (31.5%): 714 inactive symbol(s) with no delisted_at. Rows carry survivorship_clean=false.
...
Stale-feed quarantine: 1,963 graded observation(s) over 464 symbol(s) and 27 trading day(s) EXCLUDED - minted on a day this symbol's own feed was flagged stale (dq_events kind='stale'), so the inputs behind the call had already been declared unfit. Grading them would measure the outage, not the predictor.
Survivorship bound (measured 2026-09-02T01:03:27Z, edgar:form-25): 8 symbol(s) left the tracked universe since 2026-07-24 vs 1,043 graded. If every dropped symbol
had kept being graded and been WRONG every time, headline accuracy would fall by at most 0.39 pp.
