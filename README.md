...
_Regenerated 2026-08-19T14:05:46 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 43.9% | -12.0pp | 55.9% | [33.9%, 54.5%] | 334 |
| directional-ensemble (1w) | **FAILED — significantly worse than the naive baseline** | 43.3% | -18.6pp | 61.9% | [31.9%, 55.5%] | 250 |
| directional-ensemble (1w, high conviction) | **FAILED — significantly worse than the naive baseline** | 37.9% | -23.5pp | 61.3% | [25.0%, 52.7%] | 169 |
...
|---|---|---|
| filingsdrift21 | 50.0% | PENDING (first grade 2026-08-14, 0/30 resolved) |
