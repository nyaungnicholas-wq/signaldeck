...
Verified this run: 0.2% of graded outcomes carry a frozen baseline.
...
the daemon stops publishing it. Chained digest matches the graded rule: 353450b995a52bcea9257a8520369d8841e7fa71c70295aae925dc7cf03b429f.
  directional-ensemble (1d): n=2,767 over 24 days, design effect 7.2x -> effective n 383
  prequential-majority (1d): n=2,438 over 22 days, design effect 22.3x -> effective n 109
...
Reliability (predicted P(up) vs realized up-frequency, independent symbol-days):
  ...
  1w: p in [0.1,0.2) mean 0.173 -> realized 0.667 (n=93, 11 days) <- conviction tier
  1w: p in [0.2,0.3) mean 0.259 -> realized 0.545 (n=121, 16 days) <- conviction tier
  1w: p in [0.3,0.4) mean 0.363 -> realized 0.612 (n=1173, 22 days)
  1w: p in [0.4,0.5) mean 0.448 -> realized 0.585 (n=2154, 17 days)
  1w: p in [0.5,0.6) mean 0.544 -> realized 0.564 (n=1155, 16 days)
  1w: p in [0.6,0.7) mean 0.630 -> realized 0.602 (n=181, 12 days)
  1w: p in [0.7,0.8) mean 0.738 -> realized 0.357 (n=42, 10 days) <- conviction tier
...
Survivorship bound (measured 2026-08-28T02:00:21Z, edgar:form-25): 8 symbol(s) left the tracked universe since 2026-07-24 vs 655 graded. If every dropped symbol
