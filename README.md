...
_Regenerated 2026-08-05T16:24:12 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | NO SKILL — indistinguishable from baseline | 48.5% | -10.4pp | 58.9% | [33.8%, 63.6%] | 129 |
| directional-ensemble (1w) | INSUFFICIENT DAYS (5/10 distinct days) — no interval, so no verdict | 42.3% | -13.8pp | 56.1% | withheld | 1,251 raw |
| directional-ensemble (1d, high conviction) | INSUFFICIENT DAYS (7/10 distinct days) — no interval, so no verdict | 54.2% | -7.3pp | 61.6% | withheld | 354 raw |
| directional-ensemble (1w, high conviction) | INSUFFICIENT DAYS (5/10 distinct days) — no interval, so no verdict | 42.9% | +0.6pp | 42.2% | withheld | 77 raw |
