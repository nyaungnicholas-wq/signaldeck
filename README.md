...
_Regenerated 2026-08-04T18:23:15 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 43.1% | -13.7pp | 56.8% | [31.1%, 55.9%] | 185 |
| directional-ensemble (1w) | INSUFFICIENT DAYS (5/10 distinct days) — no interval, so no verdict | 45.6% | -6.6pp | 52.2% | withheld | 938 raw |
| directional-ensemble (1d, high conviction) | INSUFFICIENT DAYS (6/10 distinct days) — no interval, so no verdict | 55.3% | -4.7pp | 60.0% | withheld | 300 raw |
| directional-ensemble (1w, high conviction) | INSUFFICIENT DAYS (4/10 distinct days) — no interval, so no verdict | 45.2% | +0.8pp | 44.4% | withheld | 62 raw |
