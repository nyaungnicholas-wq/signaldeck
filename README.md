...
Verified this run: 63.5% of graded outcomes carry a frozen baseline.
...
Reliability (predicted P(up) vs realized up-frequency, independent symbol-days):
  ...
  1w: p in [0.3,0.4) mean 0.363 -> realized 0.608 (n=1188, 23 days)
  1w: p in [0.4,0.5) mean 0.448 -> realized 0.581 (n=2195, 19 days)
  ...
  1w: p in [0.8,0.9) mean 0.850 -> realized 0.273 (n=11, 7 days) <- conviction tier
...
Universe completeness (direction): NOT CLEAN — listing status resolvable for 328/1043 graded symbols (31.4%): 715 inactive symbol(s) with no delisted_at. Rows carry survivorship_clean=false.
Universe completeness (structure): NOT CLEAN — listing status resolvable for 287/419 graded symbols (68.5%): 132 inactive symbol(s) with no delisted_at. Rows carry survivorship_clean=false.
Stale-feed quarantine: 1,739 graded observation(s) over 460 symbol(s) and 26 trading day(s) EXCLUDED - minted on a day this symbol's own feed was flagged stale (dq_events kind='stale'), so the inputs behind the call had already been declared unfit. Grading them would measure the outage, not the predictor.
Survivorship bound (measured 2026-08-31T01:26:03Z, edgar:form-25): 9 symbol(s) left the tracked universe since 2026-07-24 vs 1,043 graded. If every dropped symbol
