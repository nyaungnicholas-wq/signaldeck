...
_Regenerated 2026-09-20T23:50:57 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | NO SKILL — indistinguishable from baseline | 52.2% | +0.7pp | 51.5% | [42.4%, 61.9%] | 416 |
| directional-ensemble (1w) | INSUFFICIENT DAYS (6/10 credible days of 33, 27 degenerate) — no interval, so no verdict | 49.7% | -3.8pp | 53.4% | withheld | 4,515 raw |
| directional-ensemble (1d, high conviction) | INSUFFICIENT (1/30) | 0.0% | -50.0pp | 50.0% | withheld | 1 raw |
| directional-ensemble (1w, high conviction) | INSUFFICIENT DAYS (6/10 credible days of 30, 24 degenerate) — no interval, so no verdict | 51.1% | -8.6pp | 59.8% | withheld | 798 raw |

**Structural claims (trend/vol/liquidity): 1/7 PENDING — backtested numbers, not live records yet.**

| Predictor | Backtest claim | Status |
|---|---|---|
| filingsdrift21 | 50.0% | NO BASELINE — naive-persistence null not frozen for these calls |
| liquidity21 | 59.5% | INSUFFICIENT BLOCKS (2/10 non-overlapping horizon blocks) — no interval, so no verdict |
| liquidity21-crypto | 79.5% | INSUFFICIENT BLOCKS (2/10 non-overlapping horizon blocks) — no interval, so no verdict |
| trend21 | 73.1% | INSUFFICIENT BLOCKS (2/10 non-overlapping horizon blocks) — no interval, so no verdict |
| trend21-crypto | 93.4% | INSUFFICIENT BLOCKS (2/10 non-overlapping horizon blocks) — no interval, so no verdict |
| trend63 | 70.0% | PENDING (first grade 2026-09-25, 0/30 resolved) |
| vol21 | 55.8% | INSUFFICIENT BLOCKS (2/10 non-overlapping horizon blocks) — no interval, so no verdict |
...
- **Ops** (`ops/`): Windows Task Scheduler jobs, defined by `ops/tasks/*.xml`, the
