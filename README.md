...
_Regenerated 2026-08-18T18:25:41 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 43.7% | -12.4pp | 56.1% | [33.7%, 54.3%] | 333 |
| directional-ensemble (1w) | **FAILED — significantly worse than the naive baseline** | 42.3% | -20.1pp | 62.4% | [30.5%, 55.0%] | 227 |
| directional-ensemble (1w, high conviction) | **FAILED — significantly worse than the naive baseline** | 35.8% | -26.9pp | 62.7% | [26.0%, 47.0%] | 297 |
