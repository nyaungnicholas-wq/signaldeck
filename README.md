...
_Regenerated 2026-08-06T14:05:06 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 44.0% | -13.6pp | 57.6% | [34.4%, 54.1%] | 320 |
| directional-ensemble (1w) | INSUFFICIENT DAYS (6/10 distinct days) — no interval, so no verdict | 41.1% | -18.4pp | 59.5% | withheld | 1,656 raw |
| directional-ensemble (1d, high conviction) | INSUFFICIENT DAYS (8/10 distinct days) — no interval, so no verdict | 48.6% | -3.5pp | 52.1% | withheld | 621 raw |
| directional-ensemble (1w, high conviction) | INSUFFICIENT DAYS (6/10 distinct days) — no interval, so no verdict | 38.9% | -8.7pp | 47.6% | withheld | 126 raw |
