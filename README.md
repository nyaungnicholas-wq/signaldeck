...
_Regenerated 2026-08-12T21:33:12 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 42.9% | -13.9pp | 56.9% | [33.0%, 53.5%] | 320 |
| directional-ensemble (1w) | INSUFFICIENT DAYS (7/10 credible days of 11, 4 degenerate) — no interval, so no verdict | 38.8% | -23.8pp | 62.6% | withheld | 2,256 raw |
| directional-ensemble (1d, high conviction) | INSUFFICIENT DAYS (5/10 credible days of 7, 2 degenerate) — no interval, so no verdict | 45.2% | -3.4pp | 48.6% | withheld | 454 raw |
| directional-ensemble (1w, high conviction) | INSUFFICIENT DAYS (9/10 credible days of 9) — no interval, so no verdict | 34.9% | -28.1pp | 62.9% | withheld | 344 raw |
