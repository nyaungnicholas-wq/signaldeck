...
_Regenerated 2026-08-09T14:05:15 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 43.0% | -10.3pp | 53.4% | [33.6%, 53.0%] | 345 |
...
| directional-ensemble (1w, high conviction) | INSUFFICIENT DAYS (7/10 distinct days) — no interval, so no verdict | 38.5% | -11.5pp | 50.0% | withheld | 117 raw |
