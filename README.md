...
Verified this run: 72.3% of graded outcomes carry a frozen baseline.
...
the daemon stops publishing it. Chained digest matches the graded rule: 353450b995a52bcea9257a8520369d8841e7fa71c70295aae925dc7cf03b429f.
  directional-ensemble (1d): n=2,799 over 25 days, design effect 7.1x -> effective n 391
  prequential-majority (1d): n=2,497 over 24 days, design effect 22.0x -> effective n 114
...
Reliability (predicted P(up) vs realized up-frequency, independent symbol-days):
  ...
  1d: p in [0.4,0.5) mean 0.469 -> realized 0.569 (n=1662, 23 days)
  1d: p in [0.5,0.6) mean 0.551 -> realized 0.554 (n=390, 17 days)
  ...
  1w: p in [0.0,0.1) mean 0.043 -> realized 0.360 (n=25, 10 days) <- conviction tier
  1w: p in [0.1,0.2) mean 0.168 -> realized 0.655 (n=113, 15 days) <- conviction tier
  1w: p in [0.2,0.3) mean 0.258 -> realized 0.517 (n=145, 20 days) <- conviction tier
  1w: p in [0.3,0.4) mean 0.363 -> realized 0.597 (n=1240, 27 days)
  1w: p in [0.4,0.5) mean 0.448 -> realized 0.576 (n=2275, 21 days)
  1w: p in [0.5,0.6) mean 0.544 -> realized 0.547 (n=1248, 20 days)
  1w: p in [0.6,0.7) mean 0.634 -> realized 0.562 (n=235, 16 days)
  1w: p in [0.7,0.8) mean 0.738 -> realized 0.333 (n=72, 14 days) <- conviction tier
  1w: p in [0.8,0.9) mean 0.852 -> realized 0.240 (n=25, 10 days) <- conviction tier
...
Universe completeness (structure): listing status resolvable for all 424 graded symbols — survivorship_clean.
Stale-feed quarantine: 1,973 graded observation(s) over 465 symbol(s) and 28 trading day(s) EXCLUDED - minted on a day this symbol's own feed was flagged stale (dq_events kind='stale'), so the inputs behind the call had already been declared unfit. Grading them would measure the outage, not the predictor.
Survivorship bound (measured 2026-09-03T01:23:37Z, edgar:form-25): 9 symbol(s) left the tracked universe since 2026-07-24 vs 1,043 graded. If every dropped symbol
had kept being graded and been WRONG every time, headline accuracy would fall by at most 0.44 pp.
