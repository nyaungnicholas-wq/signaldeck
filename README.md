...
_Regenerated 2026-08-12T17:53:20 · verdicts come from day-clustered intervals, never point estimates · survivorship epoch 2026-07-24 (earlier rows were graded against a survivor-seeded universe and are excluded)._
...
|---|---|---|---|---|---|---|
| directional-ensemble (1d) | **FAILED — significantly worse than the naive baseline** | 41.7% | -13.4pp | 55.1% | [33.7%, 50.2%] | 490 |
| directional-ensemble (1w) | **FAILED — significantly worse than the naive baseline** | 36.5% | -28.6pp | 65.1% | [29.0%, 44.7%] | 508 |
| directional-ensemble (1w, high conviction) | **FAILED — significantly worse than the naive baseline** | 38.0% | -27.7pp | 65.7% | [28.4%, 48.6%] | 310 |
| directional-ensemble (1d, high conviction) | INSUFFICIENT DAYS (8/10 distinct days) — no interval, so no verdict | 44.7% | -1.9pp | 46.6% | withheld | 452 raw |
