      ...
      {rows !== null && (
        <section className="panel">
          ...
          {list.length === 0 ? (
            <EmptyState
              className="m-4"
              message="No insider trades parsed yet"
              detail="Form 4 filings are fetched and parsed as the filings-poller sweeps the universe (~2h cadence, rate-limited per SEC policy)."
            />
          ) : (
