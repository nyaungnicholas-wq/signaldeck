...
# is one renderer too many. They cannot currently disagree, because both read
# the same JSON and both are regenerated by committed tooling, but nothing
# stops them drifting in FORMAT or in what they choose to omit. The consolidation
