...
| R8 | Regime calls on pruned symbols retried forever; 31-day silent stall, survivorship hole | **FIXED** 082e6dc - retire+count past a 3x grace window; 4 tests, mutation-checked BOTH ways; deployed. Verified in production: retired 0 because the 3x window has not elapsed (correct - see E24), and 5fb3cdd now reports the stuck count so the hole is visible today. See E22, E23, E24. |
